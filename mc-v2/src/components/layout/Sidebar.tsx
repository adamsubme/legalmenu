...
const navigation = [
  ...
  { name: 'Sprawy', href: '/cases', icon: Kanban },
  { name: 'Agenci', href: '/agents', icon: Users },
  { name: 'Eskalacje', href: '/escalations', icon: AlertTriangle },
  { name: 'Dokumenty', href: '/documents', icon: FileText },
  { name: 'Wiedza', href: '/knowledge', icon: BookOpen },
  { name: 'Koszty', href: '/costs', icon: DollarSign },
];
    ...
    <aside className="fixed inset-y-0 left-0 z-50 flex w-56 flex-col border-r border-zinc-800 bg-zinc-950">
      ...
      <div className="border-t border-zinc-800 px-2 py-3 space-y-0.5">
        ...
        <div className="mt-3 rounded-md border border-zinc-800 bg-zinc-900/50 px-3 py-2">
          ...
          <p className="mt-1 text-[10px] text-zinc-500 font-mono">6 agentów aktywnych</p>
        </div>
      </div>
    </aside>
  );
